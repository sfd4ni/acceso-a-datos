package es.iespuertodelacruz.daniel.bibliotecarest.security;
 ...
 */
 ...
 long vidaAnteriorKey = System.currentTimeMillis() -
dateCreationKey;
 key = Keys.secretKeyFor(SignatureAlgorithm.HS256);
 dateCreationKey = System.currentTimeMillis();
 ...
 public String generarToken(String username, List<String> roles, int
duracionMinutos) {
 String token = Jwts
 .builder()
